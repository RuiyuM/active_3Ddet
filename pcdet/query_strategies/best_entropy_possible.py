...
class Entropy_only_Best(Strategy):
    def __init__(self, model, labelled_loader, unlabelled_loader, rank, active_label_dir, cfg):

        super(Entropy_only_Best, self).__init__(model, labelled_loader, unlabelled_loader, rank, active_label_dir, cfg)
        ...
        for cur_it in range(total_it_each_epoch):
            ...
            with torch.no_grad():
                ...
                for batch_inx in range(len(pred_dicts)):
                    ...
                    car = pred_dicts[batch_inx]['num_bbox']['Car']
                    Pedestrain = pred_dicts[batch_inx]['num_bbox']['Pedestrian']
                    Cyclist = pred_dicts[batch_inx]['num_bbox']['Cyclist']
