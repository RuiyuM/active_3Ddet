...
class Uncertainty_Regression_CRBSampling_with_facility(Strategy):
    def __init__(self, model, labelled_loader, unlabelled_loader, rank, active_label_dir, cfg):

        super(Uncertainty_Regression_CRBSampling_with_facility, self).__init__(model, labelled_loader, unlabelled_loader, rank,
