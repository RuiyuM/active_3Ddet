...
class Set_Unifrom_invidual_uniform_with_confidence(Strategy):
    def __init__(self, model, labelled_loader, unlabelled_loader, rank, active_label_dir, cfg):

        super(Set_Unifrom_invidual_uniform_with_confidence, self).__init__(model, labelled_loader, unlabelled_loader, rank,
    ...
    def calculate_closeness(self, sample, confidence_list):
        ...
        current_difference = abs(sample['Car']/total_num * confidence_list[0] - sample['Pedestrian']/total_num * confidence_list[1]) + abs(
                        sample['Car']/total_num * confidence_list[0] - sample['Cyclist']/total_num * confidence_list[2]) + abs(sample['Pedestrian']/total_num * confidence_list[1] - sample['Cyclist']/total_num * confidence_list[2])
