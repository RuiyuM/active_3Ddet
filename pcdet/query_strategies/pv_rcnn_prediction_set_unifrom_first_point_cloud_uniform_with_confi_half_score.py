...
class Set_Unifrom_invidual_uniform_with_half_confidence(Strategy):
    def __init__(self, model, labelled_loader, unlabelled_loader, rank, active_label_dir, cfg):

        super(Set_Unifrom_invidual_uniform_with_half_confidence, self).__init__(model, labelled_loader, unlabelled_loader, rank,
    ...
    def calculate_closeness(self, sample):
        ...
        current_difference = abs(sample['Car'] / total_num - sample['Pedestrian'] / total_num) + abs(
            sample['Car'] / total_num - sample['Cyclist'] / total_num) + abs(
            sample['Pedestrian'] / total_num - sample['Cyclist'] / total_num)
