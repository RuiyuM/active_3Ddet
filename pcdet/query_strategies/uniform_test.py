...
class Uniform_test(Strategy):
    def __init__(self, model, labelled_loader, unlabelled_loader, rank, active_label_dir, cfg):

        super(Uniform_test, self).__init__(model, labelled_loader, unlabelled_loader, rank,
    ...
    def query(self, leave_pbar=True, cur_epoch=None):
        ...
        selected_frames = list(select_dic.keys())[::-1][:int(self.cfg.ACTIVE_TRAIN.SELECT_NUMS) * 3]
