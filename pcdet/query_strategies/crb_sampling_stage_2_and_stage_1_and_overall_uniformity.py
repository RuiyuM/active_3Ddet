...
class CRBSampling_stage_2_stage_1_Uniformity(Strategy):
    def __init__(self, model, labelled_loader, unlabelled_loader, rank, active_label_dir, cfg):

        super(CRBSampling_stage_2_stage_1_Uniformity, self).__init__(model, labelled_loader, unlabelled_loader, rank, active_label_dir, cfg)
    ...
    def query(self, leave_pbar=True, cur_epoch=None):
        ...
        while total_num_cyclist <= 2000 and index_of_greedy <= 100:
