...
class CRBSampling_stage_2_stage_1(Strategy):
    def __init__(self, model, labelled_loader, unlabelled_loader, rank, active_label_dir, cfg):

        super(CRBSampling_stage_2_stage_1, self).__init__(model, labelled_loader, unlabelled_loader, rank, active_label_dir, cfg)
